(function () {
    ...
    var t = {
        tr: {
            ...
            'apps.netsayacim.desc': 'ÖSYM sınavlarına (YKS, KPSS, ALES, TUS, YDS) hazırlananlar için sınav takip uygulaması. Hedef net belirle, konu ilerlemeni ve deneme sonuçlarını takip et, geçmiş yıllara dayalı tahmini sıralamanı gör.',
        ...
        en: {
            ...
            'apps.netsayacim.desc': 'An exam tracking app for students preparing for ÖSYM exams (YKS, KPSS, ALES, TUS, YDS). Set target scores, track your topic progress and practice exam results, and see an estimated ranking based on past years.',
